...
export const getLocalImagePath = (imageName) => {
  if (!imageName) return `${process.env.PUBLIC_URL}/images/placeholder.png`;
  ...
  if (cleanName.startsWith('images/')) {
    return `${process.env.PUBLIC_URL}/${cleanName}`;
  }
  
  return `${process.env.PUBLIC_URL}/images/${cleanName}`;
};
