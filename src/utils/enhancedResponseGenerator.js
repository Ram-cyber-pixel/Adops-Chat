...
import { formatLineByLine, formatResponseLineByLine } from './lineFormatUtils';
...
export const generateEnhancedResponse = (userInput, messages, responseData) => {
  ...
  const category = typeof categoryResult === 'object' ? categoryResult.category : categoryResult;
  const matchedKeywords = typeof categoryResult === 'object' ? categoryResult.matches : [];
