const questionAndAnswerData = {
    ...
    "retailBkRotation": {
      description: "Retail Uploads & QC rotation details.",
      keywords: [
      ...
      responses: [
        "Retail Uploads & QC rotations:\n\n- 50/50 rotation: AB\n- 33/33/33: AB BC CA\n- 25/25/25/25: AB CD\n- 20/20/20/20/20: AB BC CD DE EA\n- 50/25/25: AB AC\n- 25/25/50: CA CB\n\nFor the following rotations, add a note and confirm:\n- 40/60\n- 40/30/30\n- 20/40/15/25\n- 15/20/15/30/20\n\nif it is 33/33/34 must be applied as 33/33/33"
      ]
    },
    "nationalBkPairing": {
      description: "Rules for Bookend Paring LA Uploads",
      keywords: [
      ...
      responses: [
        ...
        "a) **50/50 – A/B:** Apply “A” in the top title and “B” in the bottom title. Unless anything is specifically mentioned about the Bookend pairing to bookend with itself.\n\n" +
        "b) **75/25 – AA/BB:** Apply the “A” spot both in the top and bottom title and same as follow for “B” spot.\n\n" +
        "c) **50/25/25 – AA/BB/CC:** Apply the “A” spot both in the top and bottom title and same as follow for “B” and “C” spot.\n\n" +
        "d) **33/33/33 – AB/BC/CA:** Apply “A” in the top title and “B” in the bottom title, run it for 33%, same applies for “BC” and “CA”. Unless anything is specifically mentioned about the Bookend pairing.\n\n" +
        "e) **25/25/25/25 – AB/CD:** Should apply “A” in the top title and “B” in the bottom title, run it for 50%, same applies for “CD”. Unless anything is specifically mentioned about the Bookend pairing."
      ]
    },
    "pushQcTeam": {
