...
"NEW_YORK_DATABASE": { 
  "description": "Processing rules for the New York database regarding ticket types.", 
  "keywords": ["New York", "database", "ticket processing", "Ampersand", "Points Bet", "Political Tickets"], 
  "responses": [ 
    "For the New York database, Ampersand tickets will not be processed. Only Points Bet and Political tickets will be processed." 
  ] 
} 
